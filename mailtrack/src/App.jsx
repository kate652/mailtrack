                ...
                <div style={{ border: "none", overflowX: "auto" }}>
                  ...
                  {filtered.map((mail, ri) => (
                    <div key={mail.id} className="mail-row"
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, letterSpacing: 1, color: STATUS_COLORS[mail.status], whiteSpace: "nowrap", display: "inline-block", textTransform: "uppercase" }}>{mail.status}</span>
