...
function LoginScreen({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FDFBF7", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500&family=DM+Sans:wght@300;400;500;600&family=JetBrains+Mono:wght@300;400;500&display=swap');
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .login-inp { width: 100%; background: #FDFBF7; border: 1px solid #E8E3DB; border-radius: 6px; color: #1B3A2D; font-family: 'DM Sans', sans-serif; font-weight: 400; padding: 10px 12px; font-size: 14px; outline: none; transition: all 0.15s ease; }
        .login-inp:focus { border-color: #C2D9CE; box-shadow: 0 0 0 3px rgba(184,150,90,0.4); }
      ...
      <div style={{ width: "100%", maxWidth: 400, padding: "0 32px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 14, color: "#8B9590", letterSpacing: 0.3 }}>
            Mail Management Platform
          </div>
        </div>

        {/* Card */}
        <div style={{ background: "white", border: "1px solid #E8E3DB", borderRadius: 12, borderTop: "3px solid #1B3A2D", padding: "36px 32px", boxShadow: "0 4px 16px rgba(27,58,45,0.10)" }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 7 }}>Email Address</div>
            <input
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 7 }}>Password</div>
            <input
          ...
          {error && (
            <div style={{ background: "#FDF5F5", border: "1px solid #C2A0A0", borderLeft: "3px solid #8B4A4A", borderRadius: 6, color: "#8B4A4A", padding: "10px 14px", fontSize: 13, fontWeight: 400, marginBottom: 20 }}>
              {error}
            </div>
          )}
          ...
          <button onClick={handleLogin} disabled={loading} style={{
            ...
            fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, letterSpacing: 0.5,
        ...
        <div style={{ textAlign: "center", marginTop: 24, fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, color: "#8B9590" }}>
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(27,58,45,0.85)", display: "flex", flexDirection: "column", animation: "fadeIn 0.2s ease" }}
      ...
      <div style={{ background: "white", borderBottom: "2px solid #1B3A2D", padding: "0 28px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 14, color: "#1B3A2D" }}>{fileInfo?.name}</div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {displayUrl && (
            <a href={displayUrl} download={!isRemoteUrl ? fileInfo?.name : undefined} target={isRemoteUrl ? "_blank" : undefined} rel="noreferrer"
              style={{ padding: "7px 16px", background: "transparent", color: "#566963", border: "1px solid #E8E3DB", borderRadius: 6, fontSize: 13, fontFamily: "'DM Sans', sans-serif", fontWeight: 400, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, transition: "all 0.15s ease" }}>
              ↓ Download
            </a>
          )}
          <button onClick={onClose} style={{ background: "#1B3A2D", border: "none", borderRadius: 6, color: "#FDFBF7", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, padding: "7px 16px", cursor: "pointer", transition: "background 0.15s ease" }}>
            ✕ Close
          </button>
        </div>
      </div>
      ...
      <div ref={containerRef} style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", alignItems: "center", padding: 32, gap: 16, background: "#F5F1EA" }}>
        ...
        {error && (
          <div style={{ color: "#8B4A4A", fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 14, marginTop: 80, textAlign: "center" }}>
        ...
        {isPDF && !loading && !error && pages.map((src, i) => (
          <div key={i} style={{ position: "relative", boxShadow: "0 4px 16px rgba(27,58,45,0.10)", borderRadius: 4 }}>
            {pages.length > 1 && <div style={{ position: "absolute", top: 10, right: 10, background: "#1B3A2D", color: "#FDFBF7", fontFamily: "'JetBrains Mono', monospace", fontSize: 9, letterSpacing: 1, padding: "3px 10px", borderRadius: 4 }}>{i + 1} / {pages.length}</div>}
            <img src={src} alt={`Page ${i + 1}`} style={{ display: "block", maxWidth: "min(900px, 100%)", border: "1px solid #D4CFC6", borderRadius: 4 }} />
          </div>
        ))}
        {isImage && displayUrl && <img src={displayUrl} alt={fileInfo?.name} style={{ maxWidth: "min(900px, 100%)", objectFit: "contain", border: "1px solid #D4CFC6", borderRadius: 4, boxShadow: "0 4px 16px rgba(27,58,45,0.10)" }} />}
        {!isPDF && !isImage && displayUrl && (
          <div style={{ textAlign: "center", color: "#8B9590", fontFamily: "'DM Sans', sans-serif", fontWeight: 400, marginTop: 80 }}>
            ...
            <a href={displayUrl} target="_blank" rel="noreferrer" style={{ color: "#3A6B54", fontSize: 13, fontWeight: 400 }}>Open file ↗</a>
          </div>
        )}
      </div>
    </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FDFBF7", color: "#1B3A2D", fontFamily: "'DM Sans', sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500&family=DM+Sans:wght@300;400;500;600&family=JetBrains+Mono:wght@300;400;500&display=swap');
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ::-webkit-scrollbar { width: 4px; } ::-webkit-scrollbar-track { background: #F5F1EA; } ::-webkit-scrollbar-thumb { background: #C2D9CE; border-radius: 2px; }
        .btn { cursor: pointer; border: none; font-family: inherit; transition: all 0.15s ease; }
        .btn:hover { opacity: 0.88; }
        .btn:active { opacity: 0.75; }
        .mail-row { transition: background 0.15s ease; cursor: pointer; }
        .mail-row:hover { background: rgba(27,58,45,0.04) !important; }
        ...
        .col-resize-handle::after { content: ''; display: block; width: 1px; height: 60%; background: #D4CFC6; transition: background 0.15s ease; }
        ...
        .inp { background: #FDFBF7; border: 1px solid #E8E3DB; border-radius: 6px; color: #1B3A2D; font-family: 'DM Sans', sans-serif; font-weight: 400; padding: 10px 12px; outline: none; transition: all 0.15s ease; width: 100%; font-size: 14px; }
        .inp:focus { border-color: #C2D9CE; box-shadow: 0 0 0 3px rgba(184,150,90,0.4); }
        .inp.autofilled { border-color: #8BB5A0 !important; background: #EDF3F0 !important; }
        textarea.inp { border-radius: 6px; }
        .drop-zone { border: 2px dashed #D4CFC6; border-radius: 8px; transition: all 0.15s ease; cursor: pointer; }
        ...
        .view-doc-btn { background: white; border: 1px solid #E8E3DB; border-radius: 6px; color: #3A6B54; font-family: 'DM Sans', sans-serif; font-weight: 500; font-size: 13px; padding: 7px 14px; cursor: pointer; transition: all 0.15s ease; display: flex; align-items: center; gap: 8px; }
        .view-doc-btn:hover { background: #EDF3F0; border-color: #8BB5A0; box-shadow: 0 2px 8px rgba(27,58,45,0.08); }
        ...
        .toast { animation: slideIn 0.15s ease; border-radius: 8px; }
        .fade-in { animation: fadeIn 0.15s ease; }
        .comment-bubble { background: white; border: 1px solid #E8E3DB; border-radius: 8px; padding: 14px 16px; transition: all 0.15s ease; }
        .comment-bubble:hover { border-color: #C2D9CE; box-shadow: 0 2px 8px rgba(27,58,45,0.08); }
        .comment-bubble:hover .del-comment { opacity: 1 !important; }
        .del-comment { opacity: 0; transition: opacity 0.15s ease; background: transparent; border: none; color: #8B9590; font-size: 11px; cursor: pointer; padding: 0; font-family: inherit; }
        .del-comment:hover { color: #8B4A4A; }
        .comment-inp { background: #FDFBF7; border: 1px solid #E8E3DB; border-radius: 6px; color: #1B3A2D; font-family: 'DM Sans', sans-serif; font-weight: 400; padding: 10px 12px; outline: none; transition: all 0.15s ease; resize: none; width: 100%; font-size: 14px; }
        .comment-inp:focus { border-color: #C2D9CE; box-shadow: 0 0 0 3px rgba(184,150,90,0.4); }
        @keyframes commentIn { from { opacity:0; transform: translateY(8px); } to { opacity:1; transform:translateY(0); } }
        .comment-new { animation: commentIn 0.15s ease; }
      `}</style>
      ...
      {/* Header */}
      <header style={{ background: "white", borderBottom: "1px solid #E8E3DB", borderTop: "3px solid #1B3A2D", padding: "0 40px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64, boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 12, color: "#8B9590", marginTop: 1 }}>Mail Management</div>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {[["dashboard", "Dashboard"], ["upload", "Log Mail"]].map(([v, label]) => (
            <button key={v} onClick={() => setView(v)} className="btn" style={{
              padding: "7px 20px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, borderRadius: 6,
          ...
          <div style={{ borderLeft: "1px solid #E8E3DB", paddingLeft: 16, marginLeft: 8, display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ textAlign: "right" }}>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, color: "#1B3A2D" }}>{userName}</div>
            ...
            <button className="btn" onClick={signOut} style={{
              ...
              border: "1px solid #E8E3DB", borderRadius: 6, fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 12,
            }}>Sign Out</button>
          </div>
        </div>
      </header>
      ...
      {toast && (
        <div className="toast" style={{
          ...
          padding: "12px 20px", fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, maxWidth: 400,
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
              {[{ label: "Total", val: mails.length, color: "#1B3A2D" }, ...STATUS_FLOW.map(s => ({ label: s, val: counts[s], color: STATUS_COLORS[s] }))].map(({ label, val, color }) => (
                <div key={label} style={{ background: "white", border: "1px solid #E8E3DB", borderRadius: 8, padding: "20px 24px", boxShadow: "0 1px 2px rgba(27,58,45,0.06)", transition: "box-shadow 0.15s ease" }}>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 500, color, marginBottom: 6 }}>{val}</div>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: "#8B9590", letterSpacing: 3, textTransform: "uppercase" }}>{label}</div>
                </div>
              ))}
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: "flex", gap: 10, marginBottom: 10, alignItems: "center" }}>
                ...
                <button className="btn" onClick={() => setSortOrder(s => s === "newest" ? "oldest" : "newest")} style={{
                  padding: "9px 16px", background: "white", color: "#566963", border: "1px solid #E8E3DB", borderRadius: 6,
                  fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, whiteSpace: "nowrap"
...
Dashboard: ${dashboardUrl}`
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                {/* Status filter */}
                <div style={{ display: "flex", gap: 0, border: "1px solid #E8E3DB", borderRadius: 6, background: "white", flex: 1, overflow: "hidden" }}>
                  {["All", ...STATUS_FLOW].map((f, fi) => (
                    <button key={f} onClick={() => setFilter(f)} className="tab btn" style={{
                      flex: 1, padding: "7px 10px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12,
                ...
                {/* Priority filter */}
                <div style={{ display: "flex", gap: 0, border: "1px solid #E8E3DB", borderRadius: 6, background: "white", overflow: "hidden" }}>
                  {["All", "Low", "Medium", "High"].map((p, pi) => (
                    <button key={p} onClick={() => setPriorityFilter(p)} className="tab btn" style={{
                      padding: "7px 14px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12,
                ...
                {(filter !== "All" || priorityFilter !== "All" || search) && (
                  <button className="btn" onClick={() => { setFilter("All"); setPriorityFilter("All"); setSearch(""); }} style={{
                    ...
                    border: "1px solid #E8E3DB", borderRadius: 6, fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 12, whiteSpace: "nowrap"
                  }}>✕ Clear</button>
                )}
              </div>
            </div>
            ...
            {filtered.length === 0 ? (
              <div style={{ textAlign: "center", padding: "80px 0", color: "#8B9590", fontFamily: "'Playfair Display', serif", fontSize: 24, fontWeight: 400 }}>
                {mails.length === 0 ? "No mail logged yet" : "No results match the current filters."}
              </div>
            ) : (() => {
              ...
              return (
                <div style={{ background: "white", border: "1px solid #E8E3DB", borderRadius: 8, overflowX: "auto", boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
                  {/* Header row */}
                  ...
                  {filtered.map((mail, ri) => (
                    <div key={mail.id} className="mail-row"
                      style={{ display: "grid", gridTemplateColumns: gridTemplate, paddingTop: 12, paddingBottom: 12, borderBottom: "1px solid #E8E3DB", background: ri % 2 === 0 ? "#FDFBF7" : "#F9F6F1", alignItems: "center", minWidth: "fit-content" }}
                      onClick={() => { setSelected(mail); setView("detail"); }}>
                      <span style={{ fontSize: 13, fontWeight: 500, color: "#1B3A2D", paddingLeft: 16, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{mail.sender}</span>
                      <span style={{ fontSize: 13, fontWeight: 400, color: "#566963", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{mail.recipient}</span>
                      <span style={{ fontSize: 13, fontWeight: 400, color: "#566963", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{mail.subject || "—"}</span>
                      <span style={{
                        fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: 0.5,
                        textTransform: "uppercase", whiteSpace: "nowrap",
                        display: "inline-flex", alignItems: "center", gap: 5,
                        padding: "3px 10px", borderRadius: 100,
                        background: mail.status === "Received" ? "#EDF3F0" : mail.status === "Processing" ? "#FDF8EE" : "#F5F1EA",
                        color: STATUS_COLORS[mail.status],
                        border: `1px solid ${STATUS_COLORS[mail.status]}44`,
                      }}>
                        <span style={{ width: 5, height: 5, borderRadius: "50%", background: STATUS_COLORS[mail.status], flexShrink: 0, display: "inline-block" }} />
                        {mail.status}
                      </span>
                      <span style={{
                        ...
                        padding: "3px 10px", borderRadius: 100,
                        background: "#FDFBF7", color: PRIORITY_COLORS[mail.priority || "Medium"],
                        border: `1px solid ${PRIORITY_COLORS[mail.priority || "Medium"]}44`,
                      }}>{PRIORITY_ICONS[mail.priority || "Medium"]} {mail.priority || "Medium"}</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#8B9590", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{formatDate(mail.createdAt)}</span>
        ...
        {view === "upload" && (
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            <div style={{ marginBottom: 32 }}>
              ...
              <div style={{ width: "100%", height: 2, background: "#1B3A2D", marginTop: 12, marginBottom: 8 }} />
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 14, color: "#8B9590" }}>Upload a document — AI will extract sender, recipient, and priority automatically.</div>
            </div>
              ...
              >
                ...
                {scanning ? (
                  <div className="fade-in">
                    ...
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 16, color: "#1B3A2D", marginBottom: 6 }}>Scanning Document</div>
                  ...
                  <div className="fade-in">
                    ...
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 500, color: "#1B3A2D", marginBottom: 4 }}>{fileInfo.name}</div>
                  ...
                  <div>
                    ...
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 14, color: dragging ? "#1B3A2D" : "#8B9590", marginBottom: 8 }}>
            ...
            <div style={{ display: "grid", gap: 20 }}>
              {scanResult === "success" && (
                <div className="fade-in" style={{ padding: "10px 16px", background: "#EDF3F0", border: "1px solid #C2D9CE", borderRadius: 6, fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, color: "#3A6B54" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
                  <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 6, display: "flex", gap: 8, alignItems: "center" }}>
                    From *{scanResult === "success" && form.sender && <span style={{ color: "#B8965A", fontFamily: "'JetBrains Mono', monospace", fontSize: 9 }}>◈ AI</span>}
                  </div>
                ...
                <div>
                  <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 6, display: "flex", gap: 8, alignItems: "center" }}>
                    To *{scanResult === "success" && form.recipient && <span style={{ color: "#B8965A", fontFamily: "'JetBrains Mono', monospace", fontSize: 9 }}>◈ AI</span>}
                  </div>
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 6, display: "flex", gap: 8, alignItems: "center" }}>
                  Description{scanResult === "success" && form.subject && <span style={{ color: "#B8965A", fontFamily: "'JetBrains Mono', monospace", fontSize: 9 }}>◈ AI</span>}
                </div>
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 6 }}>Notes</div>
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, color: "#1B3A2D", marginBottom: 10, display: "flex", gap: 8, alignItems: "center" }}>
                  Priority{scanResult === "success" && <span style={{ color: "#B8965A", fontFamily: "'JetBrains Mono', monospace", fontSize: 9 }}>◈ AI</span>}
                </div>
                <div style={{ display: "flex", gap: 8 }}>
                  {["Low", "Medium", "High"].map((p) => (
                    <button key={p} onClick={() => setForm(f => ({ ...f, priority: p }))} className="btn" style={{
                      flex: 1, padding: "9px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, borderRadius: 6,
                      background: form.priority === p ? PRIORITY_COLORS[p] : "white",
                      color: form.priority === p ? "white" : "#8B9590",
                      border: `1px solid ${form.priority === p ? PRIORITY_COLORS[p] : "#E8E3DB"}`,
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
                <button className="btn" onClick={handleSubmit} disabled={scanning} style={{
                  flex: 1, padding: "13px", background: scanning ? "#D9D2C5" : "#1B3A2D", color: scanning ? "#8B9590" : "#FDFBF7",
                  fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, borderRadius: 6, cursor: scanning ? "not-allowed" : "pointer",
                  transition: "background 0.15s ease",
                ...
                <button className="btn" onClick={() => { setView("dashboard"); setForm({ sender: "", recipient: "", subject: "", notes: "", priority: "Medium" }); setFileInfo(null); setFileDataUrl(null); setScanResult(null); }} style={{
                  padding: "13px 28px", background: "transparent", color: "#8B9590", fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, border: "1px solid #E8E3DB", borderRadius: 6,
                }}>Cancel</button>
              </div>
            </div>
          </div>
        ...
        {view === "detail" && selected && (() => {
          ...
          return (
            <div>
              <button className="btn" onClick={() => setView("dashboard")} style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: 13, color: "#8B9590", background: "transparent", border: "none", marginBottom: 28, display: "flex", alignItems: "center", gap: 8 }}>← Back to Dashboard</button>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
                <div>
                  ...
                  {/* Status progress */}
                  <div style={{ marginBottom: 24 }}>
                    <div style={{ display: "flex", marginBottom: 8, borderRadius: 4, overflow: "hidden" }}>
                      {STATUS_FLOW.map((s, i) => <div key={s} style={{ flex: 1, height: 4, background: i <= statusIdx ? STATUS_COLORS[s] : "#E8E3DB", transition: "background 0.15s ease" }} />)}
                    </div>
                  ...
                  {/* Metadata grid */}
                  <div style={{ marginBottom: 20, background: "white", border: "1px solid #E8E3DB", borderRadius: 8, overflow: "hidden", boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
                    {[["From", mail.sender], ["To", mail.recipient], ["Status", mail.status], ["Logged", formatDate(mail.createdAt)], ["Updated", formatDate(mail.updatedAt)]].map(([k, v], ki) => (
                      <div key={k} style={{ display: "grid", gridTemplateColumns: "120px 1fr", borderBottom: "1px solid #E8E3DB", padding: "10px 16px", background: ki % 2 === 0 ? "#FDFBF7" : "#F9F6F1" }}>
                        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, letterSpacing: 2, textTransform: "uppercase", color: "#8B9590" }}>{k}</div>
                        <div style={{ fontSize: 13, fontWeight: 400, color: k === "Status" ? STATUS_COLORS[v] : "#566963" }}>{v}</div>
                      </div>
                    ))}
                    {/* Priority row */}
                    <div style={{ padding: "12px 16px", background: "#FDFBF7" }}>
                      ...
                      <div style={{ display: "flex", gap: 6 }}>
                        {["Low", "Medium", "High"].map(p => (
                          <button key={p} className="btn" onClick={async () => {
                            ...
                            padding: "4px 14px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, borderRadius: 100,
                  ...
                  {mail.subject && (
                    <div style={{ padding: "14px 16px", background: "white", border: "1px solid #E8E3DB", borderRadius: 8, marginBottom: 12, boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 400, color: "#566963" }}>{mail.subject}</div>
                    </div>
                  )}
                  {mail.notes && (
                    <div style={{ padding: "14px 16px", background: "white", border: "1px solid #E8E3DB", borderRadius: 8, marginBottom: 12, boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 400, color: "#566963" }}>{mail.notes}</div>
                    </div>
                  )}

                  {/* Attached File */}
                  {mail.file && (
                    <div style={{ background: "white", border: "1px solid #E8E3DB", borderRadius: 8, marginBottom: 20, boxShadow: "0 1px 2px rgba(27,58,45,0.06)" }}>
                      <div style={{ padding: "12px 16px", borderBottom: "1px solid #E8E3DB", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div>
                          ...
                          <div style={{ fontSize: 13, fontWeight: 400, color: "#3A6B54", display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    {STATUS_FLOW.map(s => {
                      ...
                      return (
                        <button key={s} className="btn" onClick={() => !isCurrent && advanceStatus(mail.id, s)} style={{
                          flex: 1, padding: "10px 6px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, textAlign: "center", borderRadius: 6,
                          background: isCurrent ? STATUS_COLORS[s] : "white",
                          color: isCurrent ? "white" : "#8B9590",
                          border: `1px solid ${isCurrent ? STATUS_COLORS[s] : "#E8E3DB"}`,
                          cursor: isCurrent ? "default" : "pointer", transition: "all 0.15s ease",
                        }}>
                          {isCurrent && <div style={{ fontSize: 9, marginBottom: 3, letterSpacing: 1, opacity: 0.8 }}>Current</div>}
                          {s}
                        </button>
                      );
                    })}
                    <button className="btn" onClick={() => deleteMail(mail.id)} style={{ padding: "10px 14px", background: "white", color: "#8B4A4A", border: "1px solid #8B4A4A", borderRadius: 6, fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 12, flexShrink: 0 }}>Remove</button>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                  ...
                  <div style={{ marginBottom: 32 }}>
                    ...
                    <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 18, color: "#1B3A2D", marginBottom: 16 }}>History</div>
                    ...
                    {[...mail.history].reverse().map((h, i) => (
                      <div key={i} style={{ display: "flex", gap: 16, marginBottom: 20 }}>
                        ...
                        <div style={{ paddingBottom: 16 }}>
                          ...
                          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#8B9590", marginTop: 2 }}>{formatDate(h.time)}{h.by ? ` · ${h.by}` : ""}</div>
                          <div style={{ fontSize: 13, fontWeight: 400, color: "#566963", marginTop: 4 }}>{h.note}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div style={{ borderTop: "2px solid #1B3A2D", paddingTop: 24 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                      <div style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 18, color: "#1B3A2D" }}>Comments</div>
                    ...
                    <div style={{ marginBottom: 16, maxHeight: 320, overflowY: "auto", display: "flex", flexDirection: "column", gap: 8 }}>
                      {(!mail.comments || mail.comments.length === 0) ? (
                        <div style={{ padding: "20px 0", textAlign: "center", fontFamily: "'Playfair Display', serif", color: "#C2D9CE", fontSize: 22, fontWeight: 400 }}>
                          No comments yet
                        </div>
                      ) : (
                          ...
                          <div key={c.id} className={`comment-bubble ${i === mail.comments.length - 1 ? "comment-new" : ""}`}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                <div style={{ width: 28, height: 28, background: "#1B3A2D", borderRadius: 100, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "#C2D9CE", flexShrink: 0, fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}>
                                  {c.author.charAt(0).toUpperCase()}
                                </div>
                                <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, color: "#1B3A2D" }}>{c.author}</span>
                                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#8B9590" }}>{formatDate(c.time)}</span>
                              </div>
                              <button className="del-comment" onClick={() => deleteComment(mail.id, c.id)} title="Delete comment">✕</button>
                            </div>
                            <div style={{ fontSize: 13, fontWeight: 400, color: "#566963", lineHeight: 1.7, paddingLeft: 38 }}>{c.text}</div>
                          </div>
                        ))
                      )}
                    ...
                    {/* Comment input */}
                    <div style={{ background: "#F9F6F1", border: "1px solid #E8E3DB", borderRadius: 8, padding: 16 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
                        <div style={{ width: 28, height: 28, background: "#1B3A2D", borderRadius: 100, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "#C2D9CE", flexShrink: 0, fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}>
                          {userName.charAt(0).toUpperCase()}
                        </div>
                        <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, color: "#1B3A2D" }}>{userName}</span>
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <button className="btn" onClick={() => addComment(mail.id)} disabled={!commentText.trim()} style={{
                          padding: "8px 20px", fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 13, borderRadius: 6,
                          background: commentText.trim() ? "#1B3A2D" : "#D9D2C5",
                          color: commentText.trim() ? "#FDFBF7" : "#8B9590",
                          cursor: commentText.trim() ? "pointer" : "not-allowed", transition: "all 0.15s ease", border: "none",
                        }}>Post Comment</button>
                      </div>
                    </div>
                  </div>
